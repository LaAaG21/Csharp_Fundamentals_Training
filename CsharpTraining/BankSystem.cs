namespace CsharpTraining
{
    internal class BankSystem
    {
        static void Main(string[] args)
        {
            ...
            bool isActive = Convert.ToBoolean(Convert.ToInt16(Console.ReadLine()));
            ...
            bool isEmployed = Convert.ToBoolean(Convert.ToInt16(Console.ReadLine()));
            ...
            switch (main_menu)
            {
                ...
                case "3":
                    ...
                    Console.WriteLine("2) Fee Schedule");
                    Console.WriteLine("3) Repayment Calculator");
                    Console.WriteLine("0) Back To Main Menu");
                    ...
                    switch (sub_menu)
                    {
                        ...
                        case "1":
                            ...
                            Console.WriteLine("Holder: " + holderName + "   |   Balance: " + balance + " OMR");
                            ...
                            switch (sub_sub_menu)
                            {
                                ...
                                case "2":
                                    ...
                                    {
                                        Console.WriteLine("Account Number: ****" + (accountNumber % 10000));
                                        Console.WriteLine("Holder Name: " + holderName);
                                        Console.WriteLine("Deposit Amount: " + withdrawalAmount);
                        ...
                        case "2":
                            Console.WriteLine("=== TRANSACTION FEE SCHEDULE ===");

                            Console.WriteLine("Your Account type: " + accounttype + " (" + accountTypeFull + ")");

                            Console.WriteLine("1) Wire Transfer");
                            Console.WriteLine("2) ATM Withdrawal");
                            Console.WriteLine("3) POS Payment");
                            ...
                            const double WIRE = 5.00;
                            const double ATM_FEE = 0.50;
                            const double POS = 0.000;
                            const double ONLINE = 0.25;

                            switch (sub_sub_menu)
                            {
                                // Return To Loan Services
                                case "0":
                                    Console.WriteLine("Returning To Main Menu...");
                                    break;
                                ...
                                // Wire Transfer
                                case "1":
                                    Console.WriteLine("Base Fee : " + WIRE);
                                    Console.WriteLine("VAT (5%) : " + (WIRE * VAT_RATE));
                                    Console.WriteLine("Total    : " + (WIRE + (WIRE * VAT_RATE)));
                                    break;

                                // ATM Withdrawal
                                case "2":
                                    Console.WriteLine("Base Fee : " + ATM_FEE);
                                    Console.WriteLine("VAT (5%) : " + (ATM_FEE * VAT_RATE));
                                    Console.WriteLine("Total    : " + (ATM_FEE + (ATM_FEE * VAT_RATE)));
                                    break;

                                // POS Payment
                                case "3":
                                    Console.WriteLine("Base Fee : " + POS);
                                    Console.WriteLine("VAT (5%) : " + (POS * VAT_RATE));
                                    Console.WriteLine("Total    : " + (POS + (POS * VAT_RATE)));
                                    break;
                                // Online Transfer
                                case "4":
                                    Console.WriteLine("Base Fee : " + ONLINE);
                                    Console.WriteLine("VAT (5%) : " + (ONLINE * VAT_RATE));
                                    Console.WriteLine("Total    : " + (ONLINE + (ONLINE * VAT_RATE)));
                                    break;
                        ...
                        case "3":
                            ...
                            Console.WriteLine("Account Balance (Ref): " + balance + " OMR");
                            ...
                            switch (sub_sub_menu)
                            {
                                ...
                                case "1":
                                    ...
                                    Console.WriteLine("Monthly Payment: " + m + " OMR");
                                    Console.WriteLine("Total Repayble : " + (n * m));
                                    Console.WriteLine("Total Interest : " + ((n * m) - p));
